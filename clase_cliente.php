<?php
  ...
  class CLIENTE
  {
     ...
     public function insert_cli()
     {
         ...
         /*generar la consulta */
         $consulta="insert into CLIENTE1(NOM_CLI,mes,FECHA_I,FECHA_FI,FKCOD_PROD,empleado) values('$this->nom_cli','$this->mes','$this->fecha_i','$this->fecha_f','$this->cod_pro','$this->emp');";
