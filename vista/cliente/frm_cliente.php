        ...
        <table class="table">
            ...
            <tr>
                ...
                ?>
                    ...
                    <td>
                        <a href="?clase=cliente&funcion=ver_cli&cod_act=<?php echo $key['PKIDEN_CLI']; ?>"><img src="img/actu.jpg" alt="" width="20" height="20"></a>
                    </td>
                    <td>
                        <a href="?clase=cliente&funcion=eliminar&cod_eli=<?php echo $key['PKIDEN_CLI']; ?>" onclick="return confirmation1()"><img src="img/eli.jpg" alt="" width="23" height="23"></a>
                    </td>
