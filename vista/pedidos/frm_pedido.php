...
<body class="body">
    ...
    <section class="content-form">
        <br><br>
        <form id="for" action="?clase=pedido&&funcion=reg_pedi" method="POST">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    ?>
                        ...
                        <td>
                            <a href="?clase=pedido&&funcion=ver_pedi&cod_act=<?php echo $key['PKCOD_PED']; ?>"><img src="img/actu.jpg" alt="" width="18" height="18"></a>
                        </td>
                        <td>
                            <a href="?clase=pedido&&funcion=eliminar&cod_eli=<?php echo $key['PKCOD_PED']; ?>"><img src="img/eli.jpg" alt="" width="20" height="20"></a>
                        </td>
