...
<section class="content-form">
    <br><br>
    <form id="for" action="?clase=recibos&&funcion=reg_rec" method="POST">
        ...
        <table class="table">
            ...
            <tr>
                ...
                ?>
                    ...
                    <td>
                        <a href="?clase=recibos&&funcion=ver_rec&cod_act=<?php echo $key['PKCOD_RE']; ?>"><img src="img/actu.jpg" alt="" width="18" height="18"></a>
                    </td>
                    <td>
                        <a href="?clase=recibos&&funcion=eliminar&cod_eli=<?php echo $key['PKCOD_RE']; ?>"><img src="img/eli.jpg" alt="" width="20" height="20"></a>
                    </td>
