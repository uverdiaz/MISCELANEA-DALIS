<?php
  ...
  class CLIENTE extends PERSONA
  {
     ...
     public function insert_cli()
     {
         ...
         /*generar la consulta */
         $consulta="insert into CLIENTE1(PKIDEN_CLI,NOM_CLI,mes,FECHA_I,FECHA_FI,FKCOD_PROD,empleado) values('$this->iden_cli','$this->nom','$this->mes','$this->fecha_i','$this->fecha_f','$this->cod_pro','$this->emp');";
